...
"use client";
import { LogOut, Menu, X, Moon, Sun, ShoppingCart, Search, User } from "lucide-react";
...
export function MobileNav({ user, cartCount = 0, isAdmin, isSeller, className }) {
  ...
  return (
    <Sheet>
      ...
      >
        ...
        <SheetDescription className="sr-only">Main navigation links and account options</SheetDescription>
        
        <div className="flex h-full flex-col">
          <SheetHeader className="px-4 pt-4 pb-2 border-b">
            <div className="flex justify-between items-center">
              <span className="text-lg font-bold">Halal Kitchen Menu</span>
            </div>
          </SheetHeader>
