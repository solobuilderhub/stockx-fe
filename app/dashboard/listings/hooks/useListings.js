...
const listingsData = [
    ...
    },
    {
        ...
        name: "Air Jordan 1 Spider-Verse",
        styleId: "DV1748-601",
        size: "10.5",
        unitsSoldStockx: 10,
        unitsSoldGoat: 8,
        retailPrice: "$190.00",
        brandWholesale: "$100.00",
        cost: "$70.00",
        remainingQty: 10,
        askPrice: "$190.00",
        lowestAsk: "$180.00",
    ...
    ...Array.from({ length: 15 }, (_, index) => ({
        ...
        image: "https://images.stockx.com/images/Nike-Dunk-Low-Retro-White-Black-2021-Product.jpg",
        name: `Nike ${
            ["Air Max", "Dunk Low", "Air Force 1", "SB Dunk", "Blazer"][
                index % 5
            ]
        } Sample Item ${index + 1}`,
        ...
        const timer = setTimeout(() => {
            try {
                ...
                if (params.minPrice) {
                    ...
                    filteredData = filteredData.filter(
                        (item) => extractPrice(item.askPrice) >= minPrice
                    );
                }
                ...
                if (params.maxPrice) {
                    ...
                    filteredData = filteredData.filter(
                        (item) => extractPrice(item.askPrice) <= maxPrice
                    );
                }
                ...
                if (params.sortBy) {
                    switch (params.sortBy) {
                        ...
                        case "price_high":
                            filteredData.sort(
                                (a, b) =>
                                    extractPrice(b.askPrice) -
                                    extractPrice(a.askPrice)
                            );
                            break;
                        case "price_low":
                            filteredData.sort(
