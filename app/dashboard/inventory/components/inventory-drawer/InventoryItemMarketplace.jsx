...
import { ChevronDown, Edit, ListOrdered, Package } from "lucide-react";
                ...
                <Card>
                    <CardHeader className="pb-3">
                        <div className="flex justify-between items-center">
                            ...
                            <Badge
                                variant={
                                    item.stockx?.sku ? "default" : "outline"
                                }
                            >
                                {item.stockx?.sku
                                    ? "Connected"
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div>
                                    ...
                                    <p
                                        ...
                                        title={item.stockx?.productId}
                                    >
                                        {item.stockx?.productId
                                            ? item.stockx.productId.substring(
                                                  0,
                                                  12
                                              ) + "..."
                                            : "Not available"}
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-sm overflow-hidden text-ellipsis">
                                    {item.goat?.catalogId || "Not available"}
                                </p>
                            </div>
