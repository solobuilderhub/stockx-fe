...
export default function Page() {
    ...
    }, [state, registerAttempt, router, callbackUrl]);
    ...
    return (
        ...
        >
            ...
            <div className="text-xs text-center text-muted-foreground mt-4">
                ...
                <Link href="/terms" className="text-retro-primary hover:underline mx-1">Terms of Service</Link>
                and
                <Link href="/privacy" className="text-retro-primary hover:underline mx-1">Privacy Policy</Link>
            </div>
        </AuthContainer>
    );
}